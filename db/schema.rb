...
ActiveRecord::Schema.define(version: 2021_07_08_041033) do
  ...
  create_table "job_offers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_job_offers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_job_offers_on_reset_password_token", unique: true
  end
